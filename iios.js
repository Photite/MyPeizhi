...
async function checkIn() {
  ...
  try { globalThis.location = { host: 'www.iios.club' }; } catch (_) {}
  try { globalThis.navigator = { userAgent: ua }; } catch (_) {}
  if (!globalThis.location || globalThis.location.host !== 'www.iios.club') {
    Object.defineProperty(globalThis, 'location', { configurable: true, value: { host: 'www.iios.club' } });
  }
  if (!globalThis.navigator || globalThis.navigator.userAgent !== ua) {
